...
class FullNetwork2(nn.Module):
    def __init__(self, ratio1=1/25, ratio2=1/16, nb_neighs3=9,
        ...
        super(FullNetwork2, self).__init__()
    ...
    def forward(self, points, batch):
        ...
        batch_samples2_out = batch_range.repeat_interleave(
            self.nb_neighs3
        )
        batch_samples_out = batch_range.repeat_interleave(
            self.nb_neighs3 * self.nb_neighs2
        )
        ...
        return samples2, batch_samples2, samples2_out, batch_samples2_out,\
               samples, batch_samples, samples_out, batch_samples_out,\
               points_out, batch_out