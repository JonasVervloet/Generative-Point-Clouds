...
# PATH VARIABLES
RESULT_PATH = "/data/leuven/335/vsc33597/"
NAME = "Visualization/"
...
NBS_NEIGHBOURS = [16]
MAX_NEIGHBORS = 1000
INTERVAL = np.arange(0.002, 0.052, 0.002)
NB_DECIMALS = 3
...
print("train")
analyse_dataset(train_dataset, "train data")
print("validation")
analyse_dataset(val_dataset, "validation data")